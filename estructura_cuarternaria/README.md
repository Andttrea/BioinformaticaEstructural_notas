...
-   **Recortada**: `results_alpha_fold3/Q9H9S0_trimmed.fasta`
-   **Completa**: `results_alpha_fold3/Q9H9S0.fasta`
...
-   Recortado: `results_alpha_fold3/fold_nanog_trimmed/fold_nanog_trimmed_model_0.cif`
-   Completo: `results_alpha_fold3/fold_nanog_full/fold_nanog_full_model_0.cif`

**Resultados de la evaluación:**
Los reportes de Swiss-Model se encuentran organizados en la carpeta `swiss_model`:
-   **Trimmed**: `swiss_model/NANOG_trimmed`
-   **Full**: `swiss_model/NONOG_full`
